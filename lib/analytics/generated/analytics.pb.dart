...
class AnalyticsMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnalyticsMessage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'gitjournal'), createEmptyInstance: create)
    ...
    ..aOM<DeviceInfo>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deviceInfo', protoName: 'deviceInfo', subBuilder: DeviceInfo.create)
    ..aOM<PackageInfo>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'packageInfo', protoName: 'packageInfo', subBuilder: PackageInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  factory AnalyticsMessage.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AnalyticsMessage.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AnalyticsMessage copyWith(void Function(AnalyticsMessage) updates) => super.copyWith((message) => updates(message as AnalyticsMessage)) as AnalyticsMessage; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AnalyticsMessage create() => AnalyticsMessage._();
  AnalyticsMessage createEmptyInstance() => create();
  static $pb.PbList<AnalyticsMessage> createRepeated() => $pb.PbList<AnalyticsMessage>();
  @$core.pragma('dart2js:noInline')
  static AnalyticsMessage getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AnalyticsMessage>(create);
  ...
  @$pb.TagNumber(4)
  set packageInfo(PackageInfo v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class DeviceInfo extends $pb.GeneratedMessage {
  ...
  DeviceInfo_DeviceInfo whichDeviceInfo() => _DeviceInfo_DeviceInfoByTag[$_whichOneof(0)]!;
...
class PackageInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PackageInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'gitjournal'), createEmptyInstance: create)
    ...
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'buildNumber', protoName: 'buildNumber')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'buildSignature', protoName: 'buildSignature')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  set buildNumber($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set buildSignature($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(5)
...
class AppInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AppInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'gitjournal'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'firebaseAppId', protoName: 'firebaseAppId')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'installSource', protoName: 'installSource')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set firebaseAppId($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  $core.String get installSource => $_getSZ(3);
  @$pb.TagNumber(4)
  set installSource($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasInstallSource() => $_has(3);
  @$pb.TagNumber(4)
  void clearInstallSource() => clearField(4);
}

class AndroidBuildVersion extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AndroidBuildVersion', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'gitjournal'), createEmptyInstance: create)
  ...
  factory AndroidBuildVersion.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AndroidBuildVersion.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AndroidBuildVersion copyWith(void Function(AndroidBuildVersion) updates) => super.copyWith((message) => updates(message as AndroidBuildVersion)) as AndroidBuildVersion; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AndroidBuildVersion create() => AndroidBuildVersion._();
  AndroidBuildVersion createEmptyInstance() => create();
  static $pb.PbList<AndroidBuildVersion> createRepeated() => $pb.PbList<AndroidBuildVersion>();
  @$core.pragma('dart2js:noInline')
  static AndroidBuildVersion getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AndroidBuildVersion>(create);
  static AndroidBuildVersion? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get baseOS => $_getSZ(0);
  @$pb.TagNumber(1)
  set baseOS($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set incremental($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(5)
  set release($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(7)
  set securityPatch($core.String v) { $_setString(6, v); }
  @$pb.TagNumber(7)
...
class AndroidDeviceInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AndroidDeviceInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'gitjournal'), createEmptyInstance: create)
    ..aOM<AndroidBuildVersion>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version', subBuilder: AndroidBuildVersion.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'board')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bootloader')
    ...
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'display')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fingerprint')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hardware')
    ...
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'manufacturer')
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'model')
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'product')
    ..pPS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'supported32BitAbis', protoName: 'supported32BitAbis')
    ..pPS(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'supported64BitAbis', protoName: 'supported64BitAbis')
    ..pPS(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'supportedAbis', protoName: 'supportedAbis')
    ..aOS(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tags')
    ..aOS(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type')
    ..aOB(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isPhysicalDevice', protoName: 'isPhysicalDevice')
    ..aOS(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'androidId', protoName: 'androidId')
    ..pPS(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'systemFeatures', protoName: 'systemFeatures')
    ..hasRequiredFields = false
  ;
  ...
  factory AndroidDeviceInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AndroidDeviceInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AndroidDeviceInfo copyWith(void Function(AndroidDeviceInfo) updates) => super.copyWith((message) => updates(message as AndroidDeviceInfo)) as AndroidDeviceInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AndroidDeviceInfo create() => AndroidDeviceInfo._();
  AndroidDeviceInfo createEmptyInstance() => create();
  static $pb.PbList<AndroidDeviceInfo> createRepeated() => $pb.PbList<AndroidDeviceInfo>();
  @$core.pragma('dart2js:noInline')
  static AndroidDeviceInfo getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AndroidDeviceInfo>(create);
  static AndroidDeviceInfo? _defaultInstance;

  @$pb.TagNumber(1)
  AndroidBuildVersion get version => $_getN(0);
  @$pb.TagNumber(1)
  set version(AndroidBuildVersion v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set bootloader($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(6)
  set display($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set fingerprint($core.String v) { $_setString(6, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set hardware($core.String v) { $_setString(7, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(13)
  set product($core.String v) { $_setString(12, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(17)
  set tags($core.String v) { $_setString(16, v); }
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(18)
  set type($core.String v) { $_setString(17, v); }
  @$pb.TagNumber(18)
  ...
  @$pb.TagNumber(19)
  set isPhysicalDevice($core.bool v) { $_setBool(18, v); }
  @$pb.TagNumber(19)
  ...
  @$pb.TagNumber(20)
  set androidId($core.String v) { $_setString(19, v); }
  @$pb.TagNumber(20)
...
class IosUtsname extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IosUtsname', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'gitjournal'), createEmptyInstance: create)
  ...
  factory IosUtsname.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory IosUtsname.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IosUtsname copyWith(void Function(IosUtsname) updates) => super.copyWith((message) => updates(message as IosUtsname)) as IosUtsname; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static IosUtsname getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<IosUtsname>(create);
...
class IosDeviceInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IosDeviceInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'gitjournal'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ...
    ..aOM<IosUtsname>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'utsname', subBuilder: IosUtsname.create)
    ..hasRequiredFields = false
  ;
  ...
  factory IosDeviceInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory IosDeviceInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IosDeviceInfo copyWith(void Function(IosDeviceInfo) updates) => super.copyWith((message) => updates(message as IosDeviceInfo)) as IosDeviceInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static IosDeviceInfo create() => IosDeviceInfo._();
  IosDeviceInfo createEmptyInstance() => create();
  static $pb.PbList<IosDeviceInfo> createRepeated() => $pb.PbList<IosDeviceInfo>();
  @$core.pragma('dart2js:noInline')
  static IosDeviceInfo getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<IosDeviceInfo>(create);
  ...
  @$pb.TagNumber(8)
  set utsname(IosUtsname v) { setField(8, v); }
  @$pb.TagNumber(8)
...
class LinuxDeviceInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LinuxDeviceInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'gitjournal'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version')
  ...
  factory LinuxDeviceInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory LinuxDeviceInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LinuxDeviceInfo copyWith(void Function(LinuxDeviceInfo) updates) => super.copyWith((message) => updates(message as LinuxDeviceInfo)) as LinuxDeviceInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static LinuxDeviceInfo create() => LinuxDeviceInfo._();
  LinuxDeviceInfo createEmptyInstance() => create();
  static $pb.PbList<LinuxDeviceInfo> createRepeated() => $pb.PbList<LinuxDeviceInfo>();
  @$core.pragma('dart2js:noInline')
  static LinuxDeviceInfo getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<LinuxDeviceInfo>(create);
...
class MacOSDeviceInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MacOSDeviceInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'gitjournal'), createEmptyInstance: create)
  ...
  factory MacOSDeviceInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory MacOSDeviceInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MacOSDeviceInfo copyWith(void Function(MacOSDeviceInfo) updates) => super.copyWith((message) => updates(message as MacOSDeviceInfo)) as MacOSDeviceInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static MacOSDeviceInfo create() => MacOSDeviceInfo._();
  MacOSDeviceInfo createEmptyInstance() => create();
  static $pb.PbList<MacOSDeviceInfo> createRepeated() => $pb.PbList<MacOSDeviceInfo>();
  @$core.pragma('dart2js:noInline')
  static MacOSDeviceInfo getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<MacOSDeviceInfo>(create);
  ...
  @$pb.TagNumber(6)
  set osRelease($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)
...
class WindowsDeviceInfo extends $pb.GeneratedMessage {
  ...
  factory WindowsDeviceInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory WindowsDeviceInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WindowsDeviceInfo copyWith(void Function(WindowsDeviceInfo) updates) => super.copyWith((message) => updates(message as WindowsDeviceInfo)) as WindowsDeviceInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static WindowsDeviceInfo create() => WindowsDeviceInfo._();
  WindowsDeviceInfo createEmptyInstance() => create();
  static $pb.PbList<WindowsDeviceInfo> createRepeated() => $pb.PbList<WindowsDeviceInfo>();
  @$core.pragma('dart2js:noInline')
  static WindowsDeviceInfo getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<WindowsDeviceInfo>(create);
...
class WebBrowserInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WebBrowserInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'gitjournal'), createEmptyInstance: create)
    ..e<BrowserName>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'browserName', $pb.PbFieldType.OE, protoName: 'browserName', defaultOrMaker: BrowserName.unknown, valueOf: BrowserName.valueOf, enumValues: BrowserName.values)
  ...
  factory WebBrowserInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory WebBrowserInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WebBrowserInfo copyWith(void Function(WebBrowserInfo) updates) => super.copyWith((message) => updates(message as WebBrowserInfo)) as WebBrowserInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static WebBrowserInfo create() => WebBrowserInfo._();
  WebBrowserInfo createEmptyInstance() => create();
  static $pb.PbList<WebBrowserInfo> createRepeated() => $pb.PbList<WebBrowserInfo>();
  @$core.pragma('dart2js:noInline')
  static WebBrowserInfo getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<WebBrowserInfo>(create);
  static WebBrowserInfo? _defaultInstance;

  @$pb.TagNumber(1)
  BrowserName get browserName => $_getN(0);
  @$pb.TagNumber(1)
  set browserName(BrowserName v) { setField(1, v); }
  @$pb.TagNumber(1)
